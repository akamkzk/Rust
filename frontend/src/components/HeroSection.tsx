  ...
  return (
    <section className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-[1]">
        {/* Top-left cyan glow */}
        <div className="absolute -top-1/4 -left-1/4 w-[800px] h-[800px] rounded-full opacity-20 blur-[120px] animate-pulse"
          style={{
        ...
        <div className="absolute -bottom-1/4 -right-1/4 w-[800px] h-[800px] rounded-full opacity-15 blur-[120px]"
          style={{
      ...
      <div className="absolute inset-0 z-[2] bg-cyber-black/60 backdrop-blur-[2px]" />
      ...
      {/* Content */}
      <div className="relative z-10 max-w-main mx-auto px-8 text-center">
        {/* Badge */}
        <motion.div
